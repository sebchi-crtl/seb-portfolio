...
const LeftSide = () => {
    return (
        <div className=' h-full hidden lg:flex flex-col items-center justify-end gap-4 text-red-900'>
            <div className={` ${styles.left_icon} relative flex flex-col gap-4 border-neutral-800 rounded-full border-[.2rem] p-[.6rem] `}>
                <a href="http://" target="_blank">
                    <span className='w-10 h-10 text-xl bg-slate-950 hover:bg-red-600 rounded-full inline-flex items-center justify-center 
            ...
            <div className="w-[2px] h-32 bg-neutral-900">
